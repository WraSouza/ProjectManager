namespace ProjectManager.Helpers
{
    ...
    {
        public static string userAPI = "https://1xchrq8n-5177.brs.devtunnels.ms/api/Users";

        public static string userLoginAPI = "https://1xchrq8n-5177.brs.devtunnels.ms/login";
